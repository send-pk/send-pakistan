...
export const USERS: User[] = [
  ...
  // Brands
  { id: 'brand-khaadi', name: 'Khaadi', email: 'orders@khaadi.com', role: UserRole.BRAND, status: 'ACTIVE', deliveryCharge: 250, assignedPickupDriverId: 'driver-imran', bankName: 'Meezan Bank', accountTitle: 'Khaadi Pvt Ltd', accountNumber: '01234567890123', companyPhone: '021-111-542234', correspondentName: 'Ali Raza', correspondentPhone: '0300-1234567' },
  { id: 'brand-sapphire', name: 'Sapphire', email: 'support@sapphire.pk', role: UserRole.BRAND, status: 'ACTIVE', deliveryCharge: 200, bankName: 'HBL', accountTitle: 'Sapphire Retail', accountNumber: '98765432109876', assignedPickupDriverId: 'driver-bilal', companyPhone: '042-111-738245', correspondentName: 'Fatima Ali', correspondentPhone: '0321-9876543' },
  { id: 'brand-cakes', name: 'Cakes & Bakes', email: 'info@cakesandbakes.com', role: UserRole.BRAND, status: 'ACTIVE', deliveryCharge: 300, assignedPickupDriverId: 'driver-faisal', companyPhone: '042-111-225377', correspondentName: 'Ahmed Khan', correspondentPhone: '0333-1122334' },
...
export const PARCELS: Parcel[] = [
    {
        ...
        status: ParcelStatus.DELIVERED, pickupDriverId: 'driver-imran', deliveryDriverId: 'driver-ali', codAmount: 3500, deliveryCharge: 250, tax: 40,
    ...
    },
    {
        ...
        status: ParcelStatus.DELIVERED, pickupDriverId: 'driver-bilal', deliveryDriverId: 'driver-bilal', codAmount: 5200, deliveryCharge: 200, tax: 32,
    ...
    },
    {
        ...
        status: ParcelStatus.OUT_FOR_DELIVERY, pickupDriverId: 'driver-imran', deliveryDriverId: 'driver-ali', codAmount: 2100, deliveryCharge: 250, tax: 40,
    ...
    },
    {
        ...
        status: ParcelStatus.AT_HUB, pickupDriverId: 'driver-faisal', deliveryDriverId: undefined, codAmount: 1500, deliveryCharge: 300, tax: 48,
    ...
    },
    {
        ...
        status: ParcelStatus.PICKED_UP, pickupDriverId: 'driver-bilal', deliveryDriverId: undefined, codAmount: 8900, deliveryCharge: 200, tax: 32,
    ...
    },
    {
        ...
        status: ParcelStatus.PICKED_UP, pickupDriverId: 'driver-imran', deliveryDriverId: undefined, codAmount: 4250, deliveryCharge: 250, tax: 40,
        createdAt: now.toISOString(), updatedAt: now.toISOString(), isCodReconciled: true,
    ...
    },
    {
        ...
        status: ParcelStatus.DELIVERED, pickupDriverId: 'driver-faisal', deliveryDriverId: 'driver-faisal', codAmount: 950, deliveryCharge: 300, tax: 48,
    ...
    },
     {
        ...
        status: ParcelStatus.DELIVERY_FAILED, pickupDriverId: 'driver-bilal', deliveryDriverId: 'driver-bilal', codAmount: 6300, deliveryCharge: 200, tax: 32,
    ...
    },
    {
        ...
        status: ParcelStatus.RETURNED, pickupDriverId: 'driver-imran', deliveryDriverId: 'driver-ali', codAmount: 1800, deliveryCharge: 250, tax: 40,
        createdAt: twoDaysAgo.toISOString(), updatedAt: yesterday.toISOString(), deliveryZone: 'Zone 1', isCodReconciled: true,
    ...
    },
    {
        ...
        status: ParcelStatus.PICKED_UP, pickupDriverId: 'driver-imran', deliveryDriverId: undefined, codAmount: 7200, deliveryCharge: 250, tax: 40,
        createdAt: now.toISOString(), updatedAt: now.toISOString(), isCodReconciled: true,
    ...
    },
    {
        ...
        status: ParcelStatus.BOOKED, pickupDriverId: 'driver-imran', deliveryDriverId: undefined, codAmount: 2500, deliveryCharge: 250, tax: 40,
        createdAt: now.toISOString(), updatedAt: now.toISOString(), isCodReconciled: true,
    ...
    },
     {
        ...
        status: ParcelStatus.DELIVERED, pickupDriverId: 'driver-imran', deliveryDriverId: 'driver-imran', codAmount: 1992, deliveryCharge: 250, tax: 40,
    ...
    },
    {
        ...
        status: ParcelStatus.OUT_FOR_DELIVERY, pickupDriverId: 'driver-bilal', deliveryDriverId: 'driver-bilal', codAmount: 12500, deliveryCharge: 200, tax: 32,
        createdAt: yesterday.toISOString(), updatedAt: now.toISOString(), deliveryZone: 'Zone 2', isCodReconciled: true,
    ...
    },
    {
        ...
        status: ParcelStatus.DELIVERED, pickupDriverId: 'driver-imran', deliveryDriverId: 'driver-ali', codAmount: 4800, deliveryCharge: 250, tax: 40,
    ...
    },
     {
        ...
        status: ParcelStatus.PICKED_UP, pickupDriverId: 'driver-faisal', deliveryDriverId: undefined, codAmount: 1800, deliveryCharge: 300, tax: 48,
        createdAt: now.toISOString(), updatedAt: now.toISOString(), isCodReconciled: true,
